<template>
  <div class="card border shadow-sm rounded-3 bg-white text-dark p-2 position-relative" style="width: 240px; border-top-width: 3px !important;" :class="getNodeBorderClass">
